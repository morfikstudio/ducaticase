...
// Query: *[_type == "siteContent" && sectionType == "aboutPage"]    | order(_updatedAt desc)    [0] {      _id,      aboutPage {        heroImages {          "imageDesktop": imageDesktop {            ...,            asset->          },          "imageMobile": imageMobile {            ...,            asset->          }        },        heroText,        historySection[] {          _key,          title,          subtitle,          body,          reverse,          images {            "imageDesktop": imageDesktop {              ...,              asset->            },            "imageMobile": imageMobile {              ...,              asset->            }          }        },        todaySection {          title,          subtitle,          text        },        highlightsSection[] {          _key,          title,          text,          image {            ...,            asset->          },          cta {            label,            path          }        }      }    }
