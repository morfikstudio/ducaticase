...
export type ListingLand = {
  ...
  country?: "IT" | "AT" | "FR" | "DE" | "MC" | "NL" | "ES" | "CH" | "US"
  province?:
    | "AG"
    | "AL"
    | "AN"
...
export type TailoredSearchPageSettings = {
  _type: "tailoredSearchPageSettings"
  ...
  bannerFormTitle?: LocalizedString
  bannerFormText?: LocalizedPortableText
  bannerFormCtaLabel?: LocalizedString
...
export type BusinessPageSettings = {
  ...
  >
  bannerPartnersTitle?: LocalizedString
  bannerPartnersText?: LocalizedPortableText
  bannerPartnersCta?: AboutHighlightCta
  bannerPartnersItems?: Array<
    {
      _key: string
    } & HomePartnerItem
  >
...
// Query: *[_type == "siteContent" && sectionType == "homePage"]    | order(_updatedAt desc)    [0] {      _id,      homePage {        heroTitle,        heroImage {          "imageLandscape": imageLandscape {            ...,            asset->          },          "imagePortrait": imagePortrait {            ...,            asset->          }        },        whoWeAreText1,        whoWeAreText2,        whoWeAreCta {          label,          path        },        payoffTitle,        payoffImage {          "imageLandscape": imageLandscape {            ...,            asset->          },          "imagePortrait": imagePortrait {            ...,            asset->          }        },        highlights[] {          _key,          title,          text,          image {            ...,            asset->          },          cta {            label,            path          }        },        "featuredListings": featuredListings[          coalesce(@->isArchived, false) != true        ]->{          _id,          _type,          title,          listingContractType,          price,          country,          city,          province,          address,          postalCode,          "typology": select(            _type == "listingCountryHouses" => countryHouseTypology,            _type == "listingShopsAndOffices" => shopsAndOfficesTypology,            _type == "listingIndustrial" => industrialTypology,            true => null          ),          "mainImage": mainImage {            ...,            asset->          }        },        testimonialsTitle,        testimonialsSubtitle,        testimonials[] {          _key,          text,          name,          provider        },        partnerGroups[] {          _key,          title,          partners[] {            _key,            name,            image {              ...,              asset->            }          }        }      }    }
...
// Source: src/sanity/lib/queries.ts
// Variable: BUSINESS_PAGE_SITE_CONTENT_QUERY
// Query: *[_type == "siteContent" && sectionType == "businessPage"]    | order(_updatedAt desc)    [0] {      _id,      businessPage {        heroTitle,        heroSubtitle,        heroPayoff1,        heroPayoff2,        heroCta {          label,          path        },        heroImage {          "recommendedCrop": {            "landscape": {              "aspectRatio": "20:9",              "width": 1920,              "height": 810            },            "portrait": {              "aspectRatio": "4:5",              "width": 720,              "height": 960            }          },          "imageLandscape": imageLandscape {            ...,            asset->          },          "imagePortrait": imagePortrait {            ...,            asset->          }        },        cover1Image {          "recommendedCrop": {            "landscape": {              "aspectRatio": "16:9",              "width": 1920,              "height": 1080            },            "portrait": {              "aspectRatio": "4:5",              "width": 720,              "height": 960            }          },          "imageLandscape": imageLandscape {            ...,            asset->          },          "imagePortrait": imagePortrait {            ...,            asset->          }        },        cover2Image {          "recommendedCrop": {            "landscape": {              "aspectRatio": "16:9",              "width": 1920,              "height": 1080            },            "portrait": {              "aspectRatio": "4:5",              "width": 720,              "height": 960            }          },          "imageLandscape": imageLandscape {            ...,            asset->          },          "imagePortrait": imagePortrait {            ...,            asset->          }        },        valuesTitle,        valuesSubtitle,        valuesCta {          label,          path        },        valuesImage {          ...,          asset->        },        valuesItems[] {          _key,          title        },        servicesTitle,        servicesSubtitle,        servicesCta {          label,          path        },        servicesItems[] {          _key,          title,          text        },        bannerPartnersTitle,        bannerPartnersText,        bannerPartnersCta {          label,          path        },        bannerPartnersItems[] {          _key,          name,          image {            ...,            asset->          }        }      }    }
export type BUSINESS_PAGE_SITE_CONTENT_QUERY_RESULT = {
  _id: string
  businessPage: {
    heroTitle: LocalizedString | null
    heroSubtitle: LocalizedString | null
    ...
    bannerPartnersTitle: LocalizedString | null
    bannerPartnersText: LocalizedPortableText | null
    bannerPartnersCta: {
      label: LocalizedString | null
      path:
        | "/"
...
// Source: src/sanity/lib/queries.ts
// Variable: TAILORED_SEARCH_PAGE_SITE_CONTENT_QUERY
// Query: *[_type == "siteContent" && sectionType == "tailoredSearchPage"]    | order(_updatedAt desc)    [0] {      _id,      tailoredSearchPage {        heroTitle,        heroSubtitle,        heroPayoff1,        heroPayoff2,        heroCta {          label,          path        },        heroImage {          "recommendedCrop": {            "landscape": {              "aspectRatio": "20:9",              "width": 1920,              "height": 810            },            "portrait": {              "aspectRatio": "4:5",              "width": 720,              "height": 960            }          },          "imageLandscape": imageLandscape {            ...,            asset->          },          "imagePortrait": imagePortrait {            ...,            asset->          }        },        cover1Image {          "recommendedCrop": {            "landscape": {              "aspectRatio": "16:9",              "width": 1920,              "height": 1080            },            "portrait": {              "aspectRatio": "4:5",              "width": 720,              "height": 960            }          },          "imageLandscape": imageLandscape {            ...,            asset->          },          "imagePortrait": imagePortrait {            ...,            asset->          }        },        bannerFormTitle,        bannerFormText,        bannerFormCtaLabel,        valuesTitle,        valuesSubtitle,        valuesCta {          label,          path        },        valuesImage {          ...,          asset->        },        valuesItems[] {          _key,          title        },        contactTitle,        contactSubtitle,        contactText,        banner2Title,        banner2Text,        banner2Cta {          label,          path        }      }    }
export type TAILORED_SEARCH_PAGE_SITE_CONTENT_QUERY_RESULT = {
  _id: string
  tailoredSearchPage: {
    heroTitle: LocalizedString | null
    heroSubtitle: LocalizedString | null
    ...
    bannerFormTitle: LocalizedString | null
    bannerFormText: LocalizedPortableText | null
    bannerFormCtaLabel: LocalizedString | null
    valuesTitle: LocalizedString | null
    valuesSubtitle: LocalizedString | null
    valuesCta: {
      label: LocalizedString | null
    ...
    banner2Title: LocalizedString | null
    banner2Text: LocalizedPortableText | null
    banner2Cta: {
      label: LocalizedString | null
      path:
        | "/"
...
// Query: *[_type in [    "listingResidential",    "listingCountryHouses",    "listingShopsAndOffices",    "listingIndustrial",    "listingHospitality",    "listingLand"  ] && coalesce(isArchived, false) != true && _id == $id][0]{    "metadata": {      _id,      _type,      listingContractType,      _createdAt,      _updatedAt,      _rev    },    "typology": select(      _type == "listingCountryHouses" => countryHouseTypology,      _type == "listingShopsAndOffices" => shopsAndOfficesTypology,      _type == "listingIndustrial" => industrialTypology,      true => null    ),    "propertySheet": select(      _type == "listingResidential" => {        price,        commercialAreaSqm,        condoFees,        floor,        conciergeService,        buildingYear,        heating,        energyClass      },      _type == "listingCountryHouses" => {        price,        commercialAreaSqm,        floor,        buildingYear,        heating,        energyClass      },      _type == "listingShopsAndOffices" => {        price,        commercialAreaSqm,        floor,        displayWindows,        conciergeService,        buildingYear,        heating,        energyClass      },      _type == "listingIndustrial" => {        price,        commercialAreaSqm,        floor,        heightMeters,        buildingYear,        energyClass      },      _type == "listingHospitality" => {        price,        commercialAreaSqm,        roomCount,        energyClass      },      _type == "listingLand" => {        price,        commercialAreaSqm,        landAccess,        hasFencedProperty      }    ),    "location": {      country,      province,      city,      address,      postalCode,      map,      positionInfo    },    "content": {      title,      "mainImage": mainImage {        ...,        asset->      },      // Drop image slots saved without a file: they cannot be rendered, and      // keeping them would leave holes in the grid and skew the lightbox count.      "gallery": gallery[defined(asset)] {        ...,        asset->      },      description,      excerpt    },    "floorPlans": select(      _type == "listingLand" => {        "items": null      },      {        "items": floorPlans[] {          ...,          asset->        }      }    ),    "additionalFields": select(      _type == "listingResidential" => {        furnishing,        garden,        carBox,        parkingSpaces,        hasBalcony,        hasTerrace,        hasCellar,        hasAtticRoom,        hasTavern,        hasAlarmSystem,        pool,        hasTennisCourt,        hasAccessibleAccess,        climateControl,        highlights      },      _type == "listingCountryHouses" => {        outdoorAreaSqm,        furnishing,        garden,        carBox,        parkingSpaces,        hasBalcony,        hasTerrace,        hasCellar,        hasAtticRoom,        hasTavern,        hasAlarmSystem,        pool,        hasTennisCourt,        hasAccessibleAccess,        climateControl,        condoFees,        highlights      },      _type == "listingShopsAndOffices" => {        furnishing,        hasAccessibleRestroom,        hasFlue,        hasFireProtectionSystem,        hasLoadingUnloading,        hasDrivewayAccess,        parkingSpaces,        hasAlarmSystem,        hasAccessibleAccess,        climateControl,        conciergeServiceShops,        officeLayout,        condoFees,        highlights      },      _type == "listingIndustrial" => {        hasLoadingDocks,        hasOverheadCranes,        shedAreaSqm,        officeAreaSqm,        landAreaSqm,        hasChangingRoom,        hasFencedProperty,        conciergeService,        hasAccessibleRestroom,        hasLoadingUnloading,        hasDrivewayAccess,        hasDrivableAccess,        parkingSpaces,        hasAlarmSystem,        hasAccessibleAccess,        climateControl,        heating,        highlights      },      _type == "listingHospitality" => {        hasAccessibleRestroom,        hasFlue,        hasFireProtectionSystem,        hasLoadingUnloading,        hasDrivewayAccess,        parkingSpaces,        hasAlarmSystem,        hasAccessibleAccess,        climateControl,        outdoorAreaSqm,        heating,        pool,        hasTennisCourt,        customSpecifications,        highlights      },      _type == "listingLand" => {        isBuildable,        isAgricultural,        highlights      }    ),    "relatedListings": *[      _type in [        "listingResidential",        "listingCountryHouses",        "listingShopsAndOffices",        "listingIndustrial",        "listingHospitality",        "listingLand"      ] &&      coalesce(isArchived, false) != true &&      _id != ^._id &&      _type == ^._type &&      city == ^.city    ] | order(_createdAt desc)[0...2] {      _id,      _type,      title,      listingContractType,      price,      city,      province,      address,      postalCode,      "typology": select(        _type == "listingCountryHouses" => countryHouseTypology,        _type == "listingShopsAndOffices" => shopsAndOfficesTypology,        _type == "listingIndustrial" => industrialTypology,        true => null      ),      "mainImage": mainImage {        ...,        asset->      }    }  }
...
// Source: src/sanity/lib/queries.ts
// Variable: LISTING_BY_ID_INCLUDE_ARCHIVED_QUERY
// Query: *[_type in [    "listingResidential",    "listingCountryHouses",    "listingShopsAndOffices",    "listingIndustrial",    "listingHospitality",    "listingLand"  ] && _id == $id][0]{    "metadata": {      _id,      _type,      listingContractType,      _createdAt,      _updatedAt,      _rev    },    "typology": select(      _type == "listingCountryHouses" => countryHouseTypology,      _type == "listingShopsAndOffices" => shopsAndOfficesTypology,      _type == "listingIndustrial" => industrialTypology,      true => null    ),    "propertySheet": select(      _type == "listingResidential" => {        price,        commercialAreaSqm,        condoFees,        floor,        conciergeService,        buildingYear,        heating,        energyClass      },      _type == "listingCountryHouses" => {        price,        commercialAreaSqm,        floor,        buildingYear,        heating,        energyClass      },      _type == "listingShopsAndOffices" => {        price,        commercialAreaSqm,        floor,        displayWindows,        conciergeService,        buildingYear,        heating,        energyClass      },      _type == "listingIndustrial" => {        price,        commercialAreaSqm,        floor,        heightMeters,        buildingYear,        energyClass      },      _type == "listingHospitality" => {        price,        commercialAreaSqm,        roomCount,        energyClass      },      _type == "listingLand" => {        price,        commercialAreaSqm,        landAccess,        hasFencedProperty      }    ),    "location": {      country,      province,      city,      address,      postalCode,      map,      positionInfo    },    "content": {      title,      "mainImage": mainImage {        ...,        asset->      },      // Drop image slots saved without a file: they cannot be rendered, and      // keeping them would leave holes in the grid and skew the lightbox count.      "gallery": gallery[defined(asset)] {        ...,        asset->      },      description,      excerpt    },    "floorPlans": select(      _type == "listingLand" => {        "items": null      },      {        "items": floorPlans[] {          ...,          asset->        }      }    ),    "additionalFields": select(      _type == "listingResidential" => {        furnishing,        garden,        carBox,        parkingSpaces,        hasBalcony,        hasTerrace,        hasCellar,        hasAtticRoom,        hasTavern,        hasAlarmSystem,        pool,        hasTennisCourt,        hasAccessibleAccess,        climateControl,        highlights      },      _type == "listingCountryHouses" => {        outdoorAreaSqm,        furnishing,        garden,        carBox,        parkingSpaces,        hasBalcony,        hasTerrace,        hasCellar,        hasAtticRoom,        hasTavern,        hasAlarmSystem,        pool,        hasTennisCourt,        hasAccessibleAccess,        climateControl,        condoFees,        highlights      },      _type == "listingShopsAndOffices" => {        furnishing,        hasAccessibleRestroom,        hasFlue,        hasFireProtectionSystem,        hasLoadingUnloading,        hasDrivewayAccess,        parkingSpaces,        hasAlarmSystem,        hasAccessibleAccess,        climateControl,        conciergeServiceShops,        officeLayout,        condoFees,        highlights      },      _type == "listingIndustrial" => {        hasLoadingDocks,        hasOverheadCranes,        shedAreaSqm,        officeAreaSqm,        landAreaSqm,        hasChangingRoom,        hasFencedProperty,        conciergeService,        hasAccessibleRestroom,        hasLoadingUnloading,        hasDrivewayAccess,        hasDrivableAccess,        parkingSpaces,        hasAlarmSystem,        hasAccessibleAccess,        climateControl,        heating,        highlights      },      _type == "listingHospitality" => {        hasAccessibleRestroom,        hasFlue,        hasFireProtectionSystem,        hasLoadingUnloading,        hasDrivewayAccess,        parkingSpaces,        hasAlarmSystem,        hasAccessibleAccess,        climateControl,        outdoorAreaSqm,        heating,        pool,        hasTennisCourt,        customSpecifications,        highlights      },      _type == "listingLand" => {        isBuildable,        isAgricultural,        highlights      }    ),    "relatedListings": *[      _type in [        "listingResidential",        "listingCountryHouses",        "listingShopsAndOffices",        "listingIndustrial",        "listingHospitality",        "listingLand"      ] &&      coalesce(isArchived, false) != true &&      _id != ^._id &&      _type == ^._type &&      city == ^.city    ] | order(_createdAt desc)[0...2] {      _id,      _type,      title,      listingContractType,      price,      city,      province,      address,      postalCode,      "typology": select(        _type == "listingCountryHouses" => countryHouseTypology,        _type == "listingShopsAndOffices" => shopsAndOfficesTypology,        _type == "listingIndustrial" => industrialTypology,        true => null      ),      "mainImage": mainImage {        ...,        asset->      }    }  }
export type LISTING_BY_ID_INCLUDE_ARCHIVED_QUERY_RESULT =
  | {
      metadata: {
        _id: string
        _type: "listingCountryHouses"
...
// Source: src/sanity/lib/queries.ts
// Variable: LISTING_SITEMAP_IDS_QUERY
// Query: *[_type in [    "listingResidential",    "listingCountryHouses",    "listingShopsAndOffices",    "listingIndustrial",    "listingHospitality",    "listingLand"  ] && coalesce(isArchived, false) != true] {    _id,    _updatedAt  }
export type LISTING_SITEMAP_IDS_QUERY_RESULT = Array<{
  _id: string
  _updatedAt: string
}>
