...
import { PARKING_SPACES_OPTIONS } from "../../../lib/constants"
import { FIELD_REQUIRED_IT } from "../../../lib/validationMessages"

type ParkingSpacesValue = {
  choice?: string | null
  otherSpecification?: string | null
} | null

const parkingSpacesObjectOptions = {
  selectWithOther: {
    choiceField: "choice",
...
export type ParkingSpacesFieldOptions = {
  required?: boolean
  group?: string
}

export function parkingSpacesField(options?: ParkingSpacesFieldOptions) {
  ...
  return defineField({
    ...
    title: "Posti auto",
    type: "object",
    options: parkingSpacesObjectOptions as Record<string, unknown>,
    components: {
      ...
      defineField({
        ...
        validation: (Rule) =>
          Rule.custom((fieldValue, context) => {
            const parent = context.parent as ParkingSpacesValue
